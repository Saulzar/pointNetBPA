...
test_dataset = PartDataset(root = '../PointNet_Data', classification = True, train = False, npoints = opt.num_points)
...
optimizer = optim.SGD(classifier.parameters(), lr=0.00000001, momentum=0.9)
# classifier.cuda()
